...
const url = "http://edurekainternship.herokuapp.com/rest?mealtype="
class CuisineFilter extends Component{
    ...
    render(){
        return(
            <React.Fragment>
                <center className="filterheader">Cuisine</center>
                <div className="filter" onChange={this.Cuisinefilter}>
