...
const url = "https://edurekainternship.herokuapp.com/city";
const rurl = "https://edurekainternship.herokuapp.com/rest?city="
            ...
            <React.Fragment>
                <div class="imageContainer">
                    <div style={{textAlign:'right'}}>
                        <a className="fb myfont" href="https://www.facebook.com/zomato/" target="_blank">
                            <img src="/images/facebook.png" className="social_logo"/>
                        </a>
                        <a class="yt myfont" href="https://youtu.be/xH4vzjqH3fs" target="_blank">
